...
CREATE TABLE CONFIGURATION (
	...
	DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;

	ALTER TABLE CONFIGURATION VOLATILE;
	-- *****************************************************************
--  Grant privileges on the table to the JDBC connection user
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE CONFIGURATION TO USER @ECMClient_DBUSER@ WITH GRANT OPTION;
GRANT CONTROL ON TABLE CONFIGURATION TO USER @ECMClient_DBUSER@;
-- *****************************************************************
...
CREATE TABLE APP_LOCK (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, category VARCHAR(30) NOT NULL, LOCK_STATUS BIGINT, objectID BIGINT, version INTEGER, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE TaskAudit (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, EVT_ACTION VARCHAR(128), EVT_TS TIMESTAMP, EVT_INFO CLOB(1M), EVT_TYPE VARCHAR(128), originator VARCHAR(380), status VARCHAR(128), TASK_ID BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE Batches (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, BATCH_DATA BLOB, CREATED_BY VARCHAR(128), SEQ_ID BIGINT, START_TIME TIMESTAMP, status BIGINT, STOP_TIME TIMESTAMP, SUCCESS_CNT BIGINT, TASK_ID BIGINT, TOTAL_CNT BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE Server (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, ACCESS_TIME TIMESTAMP, name VARCHAR(80) NOT NULL, serverURL VARCHAR(256), port BIGINT, PROC_ID BIGINT, protocol VARCHAR(10), status BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE Task (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, AUTO_RESUME BIGINT, CREATED_BY VARCHAR(128), description VARCHAR(1024), END_TIME TIMESTAMP, HANDLER_NAME VARCHAR(256) NOT NULL, LOCAL_STATE BIGINT, LOG_LEV VARCHAR(8), name VARCHAR(256) NOT NULL, NOTIFY_INFO CLOB(1M), parent VARCHAR(256), REPEAT_PERIOD BIGINT, SERVER_ID BIGINT, START_TIME TIMESTAMP, status BIGINT, STOP_TIME TIMESTAMP, SUCCESS_CNT BIGINT, TASK_INFO CLOB(1M), TASK_MODE BIGINT, TIMER_HANDLE VARCHAR(512), TOTAL_CNT BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE TASK_ERROR (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, CREATE_TIME TIMESTAMP, ERROR_CODE BIGINT, ERROR_MSG VARCHAR(1024), TASK_ID BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE TASK_EXREC (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, SERVER_ID BIGINT, START_TIME TIMESTAMP, status BIGINT, STOP_TIME TIMESTAMP, SUCCESS_CNT BIGINT, EXEC_INFO CLOB(1M), TASK_ID BIGINT, TOTAL_CNT BIGINT, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE TASK_QUEUE (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, CREATED_BY VARCHAR(128), EXEC_TIME TIMESTAMP, status BIGINT, TASK_ID BIGINT NOT NULL, version INTEGER, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
CREATE TABLE TASK_SEQ_TABLE (id VARCHAR(254) NOT NULL, SEQUENCE_VALUE BIGINT default NULL, PRIMARY KEY (id)) DATA CAPTURE NONE IN @ECMClient_TBLSPACE@;
...
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE APP_LOCK TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE APP_LOCK TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE TaskAudit TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE TaskAudit TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE Batches TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE Batches TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE Server TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE Server TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE Task TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE Task TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE TASK_ERROR TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE TASK_ERROR TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE TASK_EXREC TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE TASK_EXREC TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE TASK_QUEUE TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE TASK_QUEUE TO USER @ECMClient_DBUSER@;

GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE TASK_SEQ_TABLE TO USER @ECMClient_DBUSER@;
GRANT CONTROL ON TABLE TASK_SEQ_TABLE TO USER @ECMClient_DBUSER@;
...
CREATE TABLE SYNCREPOSMAPPING ( ID BIGINT  NOT NULL  GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1, NO CACHE ) , TABLENAMEPREFIX VARCHAR (16)  NOT NULL , REPOSID1 VARCHAR (36)  NOT NULL , REPOSID2 VARCHAR (36)  NOT NULL , CONNECTIONINFO VARCHAR (256) , EVENTID VARCHAR (36)  NOT NULL , REPOSTYPE SMALLINT  NOT NULL  WITH DEFAULT 0 , LASTUPDATEID BIGINT  NOT NULL WITH DEFAULT 0 , LASTMODRECEIVED TIMESTAMP , MARKDELETED SMALLINT  NOT NULL  WITH DEFAULT 0 , CODEMODULEREV SMALLINT, CONSTRAINT CC1392679913540 PRIMARY KEY ( ID) , CONSTRAINT CC1392679924904 UNIQUE ( TABLENAMEPREFIX) ) IN @ECMClient_TBLSPACE@ ;
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE SYNCREPOSMAPPING TO USER @ECMClient_DBUSER@;

CREATE TABLE SYNCITEMS ( ID BIGINT  NOT NULL  GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1, NO CACHE ) , NAME VARCHAR (256)  NOT NULL , OBJECTID VARCHAR (36)  NOT NULL , USERID VARCHAR (64)  NOT NULL , DESKTOPID VARCHAR (64)  NOT NULL , REPOSID BIGINT  NOT NULL , LASTUPDATETS TIMESTAMP NOT NULL WITH DEFAULT , MARKDELETED SMALLINT  NOT NULL  WITH DEFAULT 0  , CONSTRAINT CC1392680242650 PRIMARY KEY ( ID) , CONSTRAINT CC1392680358320 FOREIGN KEY (REPOSID) REFERENCES SYNCREPOSMAPPING (ID)  ON DELETE NO ACTION ON UPDATE NO ACTION ENFORCED  ENABLE QUERY OPTIMIZATION  ) IN @ECMClient_TBLSPACE@ ;
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE SYNCITEMS TO USER @ECMClient_DBUSER@;

CREATE TABLE DEVICEREGISTRY ( ID BIGINT  NOT NULL  GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1, NO CACHE ) , DEVICEID VARCHAR (36)  NOT NULL , LASTPING TIMESTAMP , MARKDELETED SMALLINT  NOT NULL  WITH DEFAULT 0  , CONSTRAINT CC1392680754897 PRIMARY KEY ( ID) , CONSTRAINT CC1392680759037 UNIQUE ( DEVICEID)  ) IN @ECMClient_TBLSPACE@ ;
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE DEVICEREGISTRY TO USER @ECMClient_DBUSER@;

CREATE TABLE DEVICESYNCMAP ( ID BIGINT  NOT NULL  GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1, NO CACHE ) , DEVREGID BIGINT  NOT NULL , SYNCITEMID BIGINT  NOT NULL , MARKDELETED SMALLINT  NOT NULL  WITH DEFAULT 0  , CONSTRAINT CC1392681213562 PRIMARY KEY ( ID) , CONSTRAINT CC1392681269094 FOREIGN KEY (DEVREGID) REFERENCES DEVICEREGISTRY (ID)  ON DELETE NO ACTION ON UPDATE NO ACTION ENFORCED  ENABLE QUERY OPTIMIZATION , CONSTRAINT CC1392681292746 FOREIGN KEY (SYNCITEMID) REFERENCES SYNCITEMS (ID)  ON DELETE NO ACTION ON UPDATE NO ACTION ENFORCED  ENABLE QUERY OPTIMIZATION  ) IN @ECMClient_TBLSPACE@ ;
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE DEVICESYNCMAP TO USER @ECMClient_DBUSER@;

CREATE TABLE SYNCCONFIGURATION ( ID VARCHAR(256) NOT NULL, ATTRIBUTES DBCLOB INLINE LENGTH 32412, PRIMARY KEY(ID) ) IN @ECMClient_TBLSPACE@;
ALTER TABLE SYNCCONFIGURATION VOLATILE;
GRANT INSERT, DELETE, UPDATE, SELECT, INDEX ON TABLE SYNCCONFIGURATION TO USER @ECMClient_DBUSER@;
